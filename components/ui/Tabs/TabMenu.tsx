                ...
                <Tabs defaultValue="account" className="w-full">
                    ...
                    <TabsContent value="account">
                        <ul className="grid gap-3 sm:grid-cols-3">
                            <li><ProjectCard title="SwingCase" description="Swing Case API generates 10 growing stocks for swing trades, helping traders make informed investments." social={[{ social: "Github", link: "https://github.com/dEvAshirvad/Swing-Case-Backend" }]} inprogres={true} /></li>
