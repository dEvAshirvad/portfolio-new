                ...
                <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="sm:pl-6 flex flex-col justify-between">
                        ...
                        <ul className="sm:flex my-4 sm:my-0 gap-3 sm:gap-5 hidden">
                            <li>
                                <Link href={"https://twitter.com/dEvAshirvad"} className="flex gap-2 socialUnderline">
                            ...
                            <li>
                                <Link href={"https://github.com/dEvAshirvad"} className="flex gap-2 socialUnderline"><Github className="socialIcon" /> <span className="hidden sm:block socialText">Github</span></Link>
                            </li>
                            <li>
                                <Link href={"https://www.linkedin.com/in/ashirvad-satapathy-2291961b7/"} className="flex gap-2 socialUnderline">
                            ...
                            <li>
                                <Link href={"https://hashnode.com/@hellojicky"} className="flex gap-2 socialUnderline">
